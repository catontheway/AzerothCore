...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "achievement", SEC_DEVELOPER,  true,  &HandleReloadAllAchievementCommand, "" },
            { "area",        SEC_DEVELOPER,  true,  &HandleReloadAllAreaCommand,       "" },
            { "gossips",     SEC_DEVELOPER,  true,  &HandleReloadAllGossipsCommand,    "" },
            { "item",        SEC_DEVELOPER,  true,  &HandleReloadAllItemCommand,       "" },
            { "locales",     SEC_DEVELOPER,  true,  &HandleReloadAllLocalesCommand,    "" },
            { "loot",        SEC_DEVELOPER,  true,  &HandleReloadAllLootCommand,       "" },
            { "npc",         SEC_DEVELOPER,  true,  &HandleReloadAllNpcCommand,        "" },
            { "quest",       SEC_DEVELOPER,  true,  &HandleReloadAllQuestCommand,      "" },
            { "scripts",     SEC_DEVELOPER,  true,  &HandleReloadAllScriptsCommand,    "" },
            { "spell",       SEC_DEVELOPER,  true,  &HandleReloadAllSpellCommand,      "" },
            { "",            SEC_DEVELOPER,  true,  &HandleReloadAllCommand,           "" }
        };
        static std::vector<ChatCommand> reloadCommandTable =
        {
            { "auctions",                     SEC_DEVELOPER, true,  &HandleReloadAuctionsCommand,                   "" },
            { "access_requirement",           SEC_DEVELOPER, true,  &HandleReloadAccessRequirementCommand,          "" },
            { "achievement_criteria_data",    SEC_DEVELOPER, true,  &HandleReloadAchievementCriteriaDataCommand,    "" },
            { "achievement_reward",           SEC_DEVELOPER, true,  &HandleReloadAchievementRewardCommand,          "" },
            { "all",                          SEC_DEVELOPER, true,  nullptr,                                        "", reloadAllCommandTable },
            { "areatrigger",                  SEC_DEVELOPER, true,  &HandleReloadAreaTriggerCommand,                "" },
            { "areatrigger_involvedrelation", SEC_DEVELOPER, true,  &HandleReloadQuestAreaTriggersCommand,          "" },
            { "areatrigger_tavern",           SEC_DEVELOPER, true,  &HandleReloadAreaTriggerTavernCommand,          "" },
            { "areatrigger_teleport",         SEC_DEVELOPER, true,  &HandleReloadAreaTriggerTeleportCommand,        "" },
            { "autobroadcast",                SEC_DEVELOPER, true,  &HandleReloadAutobroadcastCommand,              "" },
            { "broadcast_text",               SEC_DEVELOPER, true,  &HandleReloadBroadcastTextCommand,              "" },
            { "battleground_template",        SEC_DEVELOPER, true,  &HandleReloadBattlegroundTemplate,              "" },
            { "command",                      SEC_DEVELOPER, true,  &HandleReloadCommandCommand,                    "" },
            { "conditions",                   SEC_DEVELOPER, true,  &HandleReloadConditions,                        "" },
            { "config",                       SEC_DEVELOPER, true,  &HandleReloadConfigCommand,                     "" },
            { "creature_text",                SEC_DEVELOPER, true,  &HandleReloadCreatureText,                      "" },
            { "creature_questender",          SEC_DEVELOPER, true,  &HandleReloadCreatureQuestEnderCommand,         "" },
            { "creature_linked_respawn",      SEC_DEVELOPER,    true,  &HandleReloadLinkedRespawnCommand,              "" },
            { "creature_loot_template",       SEC_DEVELOPER, true,  &HandleReloadLootTemplatesCreatureCommand,      "" },
            { "creature_onkill_reputation",   SEC_DEVELOPER, true,  &HandleReloadOnKillReputationCommand,           "" },
            { "creature_queststarter",        SEC_DEVELOPER, true,  &HandleReloadCreatureQuestStarterCommand,       "" },
            { "creature_template",            SEC_DEVELOPER, true,  &HandleReloadCreatureTemplateCommand,           "" },
            { "disables",                     SEC_DEVELOPER, true,  &HandleReloadDisablesCommand,                   "" },
            { "disenchant_loot_template",     SEC_DEVELOPER, true,  &HandleReloadLootTemplatesDisenchantCommand,    "" },
            { "event_scripts",                SEC_DEVELOPER, true,  &HandleReloadEventScriptsCommand,               "" },
            { "fishing_loot_template",        SEC_DEVELOPER, true,  &HandleReloadLootTemplatesFishingCommand,       "" },
            { "game_graveyard",               SEC_DEVELOPER, true,  &HandleReloadGameGraveyardCommand,              "" },
            { "graveyard_zone",               SEC_DEVELOPER, true,  &HandleReloadGameGraveyardZoneCommand,          "" },
            { "game_tele",                    SEC_DEVELOPER, true,  &HandleReloadGameTeleCommand,                   "" },
            { "gameobject_questender",        SEC_DEVELOPER, true,  &HandleReloadGOQuestEnderCommand,               "" },
            { "gameobject_loot_template",     SEC_DEVELOPER, true,  &HandleReloadLootTemplatesGameobjectCommand,    "" },
            { "gameobject_queststarter",      SEC_DEVELOPER, true,  &HandleReloadGOQuestStarterCommand,             "" },
            { "gm_tickets",                   SEC_DEVELOPER, true,  &HandleReloadGMTicketsCommand,                  "" },
            { "gossip_menu",                  SEC_DEVELOPER, true,  &HandleReloadGossipMenuCommand,                 "" },
            { "gossip_menu_option",           SEC_DEVELOPER, true,  &HandleReloadGossipMenuOptionCommand,           "" },
            { "item_enchantment_template",    SEC_DEVELOPER, true,  &HandleReloadItemEnchantementsCommand,          "" },
            { "item_loot_template",           SEC_DEVELOPER, true,  &HandleReloadLootTemplatesItemCommand,          "" },
            { "item_set_names",               SEC_DEVELOPER, true,  &HandleReloadItemSetNamesCommand,               "" },
            { "lfg_dungeon_rewards",          SEC_DEVELOPER, true,  &HandleReloadLfgRewardsCommand,                 "" },
            { "achievement_reward_locale",    SEC_DEVELOPER, true,  &HandleReloadLocalesAchievementRewardCommand,   "" },
            { "creature_template_locale",     SEC_DEVELOPER, true,  &HandleReloadLocalesCreatureCommand,            "" },
            { "creature_text_locale",         SEC_DEVELOPER, true,  &HandleReloadLocalesCreatureTextCommand,        "" },
            { "gameobject_template_locale",   SEC_DEVELOPER, true,  &HandleReloadLocalesGameobjectCommand,          "" },
            { "gossip_menu_option_locale",    SEC_DEVELOPER, true,  &HandleReloadLocalesGossipMenuOptionCommand,    "" },
            { "item_template_locale",         SEC_DEVELOPER, true,  &HandleReloadLocalesItemCommand,                "" },
            { "item_set_name_locale",         SEC_DEVELOPER, true,  &HandleReloadLocalesItemSetNameCommand,         "" },
            { "npc_text_locale",              SEC_DEVELOPER, true,  &HandleReloadLocalesNpcTextCommand,             "" },
            { "page_text_locale",             SEC_DEVELOPER, true,  &HandleReloadLocalesPageTextCommand,            "" },
            { "points_of_interest_locale",    SEC_DEVELOPER, true,  &HandleReloadLocalesPointsOfInterestCommand,    "" },
            { "quest_template_locale",        SEC_DEVELOPER, true,  &HandleReloadLocalesQuestCommand,               "" },
            { "quest_offer_reward_locale",    SEC_DEVELOPER, true,  &HandleReloadLocalesQuestOfferRewardCommand,    "" },
            { "quest_request_item_locale",    SEC_DEVELOPER, true,  &HandleReloadLocalesQuestRequestItemsCommand,   "" },
            { "mail_level_reward",            SEC_DEVELOPER, true,  &HandleReloadMailLevelRewardCommand,            "" },
            { "mail_loot_template",           SEC_DEVELOPER, true,  &HandleReloadLootTemplatesMailCommand,          "" },
            { "milling_loot_template",        SEC_DEVELOPER, true,  &HandleReloadLootTemplatesMillingCommand,       "" },
            { "npc_spellclick_spells",        SEC_DEVELOPER, true,  &HandleReloadSpellClickSpellsCommand,           "" },
            { "npc_trainer",                  SEC_DEVELOPER, true,  &HandleReloadNpcTrainerCommand,                 "" },
            { "npc_vendor",                   SEC_DEVELOPER, true,  &HandleReloadNpcVendorCommand,                  "" },
            { "page_text",                    SEC_DEVELOPER, true,  &HandleReloadPageTextsCommand,                  "" },
            { "pickpocketing_loot_template",  SEC_DEVELOPER, true,  &HandleReloadLootTemplatesPickpocketingCommand, "" },
            { "points_of_interest",           SEC_DEVELOPER, true,  &HandleReloadPointsOfInterestCommand,           "" },
            { "prospecting_loot_template",    SEC_DEVELOPER, true,  &HandleReloadLootTemplatesProspectingCommand,   "" },
            { "quest_poi",                    SEC_DEVELOPER, true,  &HandleReloadQuestPOICommand,                   "" },
            { "quest_template",               SEC_DEVELOPER, true,  &HandleReloadQuestTemplateCommand,              "" },
            { "reference_loot_template",      SEC_DEVELOPER, true,  &HandleReloadLootTemplatesReferenceCommand,     "" },
            { "reserved_name",                SEC_DEVELOPER, true,  &HandleReloadReservedNameCommand,               "" },
            { "reputation_reward_rate",       SEC_DEVELOPER, true,  &HandleReloadReputationRewardRateCommand,       "" },
            { "reputation_spillover_template", SEC_DEVELOPER, true,  &HandleReloadReputationRewardRateCommand,      "" },
            { "skill_discovery_template",     SEC_DEVELOPER, true,  &HandleReloadSkillDiscoveryTemplateCommand,     "" },
            { "skill_extra_item_template",    SEC_DEVELOPER, true,  &HandleReloadSkillExtraItemTemplateCommand,     "" },
            { "skill_fishing_base_level",     SEC_DEVELOPER, true,  &HandleReloadSkillFishingBaseLevelCommand,      "" },
            { "skinning_loot_template",       SEC_DEVELOPER, true,  &HandleReloadLootTemplatesSkinningCommand,      "" },
            { "smart_scripts",                SEC_DEVELOPER, true,  &HandleReloadSmartScripts,                      "" },
            { "spell_required",               SEC_DEVELOPER, true,  &HandleReloadSpellRequiredCommand,              "" },
            { "spell_area",                   SEC_DEVELOPER, true,  &HandleReloadSpellAreaCommand,                  "" },
            { "spell_bonus_data",             SEC_DEVELOPER, true,  &HandleReloadSpellBonusesCommand,               "" },
            { "spell_group",                  SEC_DEVELOPER, true,  &HandleReloadSpellGroupsCommand,                "" },
            { "spell_loot_template",          SEC_DEVELOPER, true,  &HandleReloadLootTemplatesSpellCommand,         "" },
            { "spell_linked_spell",           SEC_DEVELOPER, true,  &HandleReloadSpellLinkedSpellCommand,           "" },
            { "spell_pet_auras",              SEC_DEVELOPER, true,  &HandleReloadSpellPetAurasCommand,              "" },
            { "spell_proc_event",             SEC_DEVELOPER, true,  &HandleReloadSpellProcEventCommand,             "" },
            { "spell_proc",                   SEC_DEVELOPER, true,  &HandleReloadSpellProcsCommand,                 "" },
            { "spell_scripts",                SEC_DEVELOPER, true,  &HandleReloadSpellScriptsCommand,               "" },
            { "spell_target_position",        SEC_DEVELOPER, true,  &HandleReloadSpellTargetPositionCommand,        "" },
            { "spell_threats",                SEC_DEVELOPER, true,  &HandleReloadSpellThreatsCommand,               "" },
            { "spell_group_stack_rules",      SEC_DEVELOPER, true,  &HandleReloadSpellGroupStackRulesCommand,       "" },
            { "acore_string",                 SEC_DEVELOPER, true,  &HandleReloadAcoreStringCommand,              "" },
            { "warden_action",                SEC_DEVELOPER, true,  &HandleReloadWardenactionCommand,               "" },
            { "waypoint_scripts",             SEC_DEVELOPER, true,  &HandleReloadWpScriptsCommand,                  "" },
            { "waypoint_data",                SEC_DEVELOPER, true,  &HandleReloadWpCommand,                         "" },
            { "vehicle_accessory",            SEC_DEVELOPER, true,  &HandleReloadVehicleAccessoryCommand,           "" },
            { "vehicle_template_accessory",   SEC_DEVELOPER, true,  &HandleReloadVehicleTemplateAccessoryCommand,   "" }
        };
