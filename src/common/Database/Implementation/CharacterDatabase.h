...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_SEL_GUILD_SYSTEM,
    CHAR_UPD_GUILD_SYSTEM_LEVEL,
    CHAR_UPD_GUILD_SYSTEM_XP,
    CHAR_UPD_GUILD_SYSTEM_ZERO_XP,
    CHAR_UPD_GUILD_SYSTEM_KILL,
    CHAR_UPD_GUILD_SYSTEM_POINT,
