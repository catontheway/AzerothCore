...
class BGScript_CrossFactionBG : public BGScript
{
public:
    BGScript_CrossFactionBG() : BGScript("BGScript_CrossFactionBG") { }
...
class PlayerScript_CrossFactionBG : public PlayerScript
{
public:
    PlayerScript_CrossFactionBG() : PlayerScript("PlayerScript_CrossFactionBG") { }
...
class WorldScript_CrossFactionBG : public WorldScript
{
public:
    WorldScript_CrossFactionBG() : WorldScript("WorldScript_CrossFactionBG") { }
...
{
    new BGScript_CrossFactionBG();
    new PlayerScript_CrossFactionBG();
    new WorldScript_CrossFactionBG();
}
