...
#define GAS session->GetAcoreString

class CreatureScript_Transmogrifier : public CreatureScript
{
public:
    CreatureScript_Transmogrifier() : CreatureScript("CreatureScript_Transmogrifier") { }
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
    {
        ...
        switch (sender)
        {
            ...
            case EQUIPMENT_SLOT_END + 2: // Remove Transmogrifications
            {
                ...
                if (removed)
                {
                    session->SendAreaTriggerMessage("%s", GAS(LANG_ERR_UNTRANSMOG_OK));
            ...
            default: // Transmogrify
            {
                ...
                if (res == LANG_ERR_TRANSMOG_OK)
                    session->SendAreaTriggerMessage("%s",GAS(LANG_ERR_TRANSMOG_OK));
                else
...
class PlayerScript_Transmogrification : public PlayerScript
{
public:
    PlayerScript_Transmogrification() : PlayerScript("Player_Transmogrify") { }
...
class WorldScript_Transmogrification : public WorldScript
{
public:
    WorldScript_Transmogrification() : WorldScript("WorldScript_Transmogrification") { }
...
class GlobalScript_Transmogrifier : public GlobalScript
{
    public:
        GlobalScript_Transmogrifier() : GlobalScript("GlobalScript_Transmogrifier") { }
...
{
    new GlobalScript_Transmogrifier();
    new CreatureScript_Transmogrifier();
    new PlayerScript_Transmogrification();
    new WorldScript_Transmogrification();
}
