...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        {
            case CLASS_WARRIOR:
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Warrior (Arms)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Warrior (Fury)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Warrior (Protection)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
                break;
            case CLASS_PALADIN:
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Paladin (Holy)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Paladin (Protection)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Paladin (Retribution)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
                break;
            case CLASS_ROGUE:
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Rogue (Assassination)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Rogue (Combat)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Rogue (Subtlety)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
                break;
            case CLASS_HUNTER:
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Hunter (Beast Mastery)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Hunter (Marksmanship)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Hunter (Survival)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 12);
                break;
            case CLASS_PRIEST:
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Priest (Discipline)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 13);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Priest (Holy)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 14);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Priest (Shadow)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 15);
                break;
            case CLASS_DEATH_KNIGHT:
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "DeathKnight (Blood)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 16);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "DeathKnight (Frost)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 17);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "DeathKnight (Unholy)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 18);
                break;
            case CLASS_SHAMAN:
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Shaman (Elemental)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 19);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Shaman (Enhancement)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 20);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Shaman (Restoration)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 21);
                break;
            case CLASS_MAGE:
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Mage (Arcane)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 22);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Mage (Fire)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 23);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Mage (Frost)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 24);
                break;
            case CLASS_WARLOCK:
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Warlock (Afflication)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 25);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Warlock (Demonology)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 26);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Warlock (Destruction)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 27);
                break;
            case CLASS_DRUID:
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Druid (Balance)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 28);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Druid (Feral Combat)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 29);
                AddGossipItemFor(player,GOSSIP_ICON_INTERACT_1, "Druid (Restoration)", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 30);
                break;
        }
    ...
    bool OnGossipSelect(Player* player, Creature* /*creature*/, uint32 /*Sender*/, uint32 Actions)
    {
        ...
        Skills skills[] =
        {
            ...
            ONE_H_SWORDS, POLEARMS, SHOOT, STAVES, TWO_H_AXES, TWO_H_MACES, TWO_H_SWORDS, WANDS, THROW_WAR, PLATE_MAIL, MAIL
        };

        for (uint32 i = 0; i < 19; ++i)
            if (player->HasSpell(skills[i]))
                continue;
        ...
        switch (Actions)
        {
            case GOSSIP_ACTION_INFO_DEF + 1:
                ...
                player->learnSpell(29724); player->addTalent(29724, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(12835); player->addTalent(12835, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 3:
                ...
                player->learnSpell(12867); player->addTalent(12867, player->GetActiveSpecMask(), true);
                player->learnSpell(61222); player->addTalent(61222, player->GetActiveSpecMask(), true);
                player->learnSpell(12852); player->addTalent(12853, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 4:
                ...
                player->learnSpell(31823); player->addTalent(31823, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 5:
                ...
                player->learnSpell(20180); player->addTalent(20180, player->GetActiveSpecMask(), true);
                player->learnSpell(20198); player->addTalent(20198, player->GetActiveSpecMask(), true);
                player->learnSpell(31785); player->addTalent(31785, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(53696); player->addTalent(53696, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 6:
                ...
                player->learnSpell(20105); player->addTalent(20105, player->GetActiveSpecMask(), true);
                player->learnSpell(25957); player->addTalent(25957, player->GetActiveSpecMask(), true);
                player->learnSpell(20336); player->addTalent(20336, player->GetActiveSpecMask(), true);
                player->learnSpell(20045); player->addTalent(20045, player->GetActiveSpecMask(), true);
                player->learnSpell(9452); player->addTalent(9452, player->GetActiveSpecMask(), true);
                player->learnSpell(20121); player->addTalent(20121, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 7:
                ...
                player->learnSpell(14116); player->addTalent(14116, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(13851); player->addTalent(13851, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 8:
                ...
                player->learnSpell(14165); player->addTalent(14165, player->GetActiveSpecMask(), true);
                player->learnSpell(13845); player->addTalent(13845, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(13964); player->addTalent(13964, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(51679); player->addTalent(51679, player->GetActiveSpecMask(), true);
                player->learnSpell(35553); player->addTalent(35553, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(51685); player->addTalent(51685, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 9:
                ...
                // Talent
                player->learnSpell(14164); player->addTalent(14164, player->GetActiveSpecMask(), true);
                player->learnSpell(14139); player->addTalent(14139, player->GetActiveSpecMask(), true);
                player->learnSpell(14161); player->addTalent(14161, player->GetActiveSpecMask(), true);
                player->learnSpell(13866); player->addTalent(13866, player->GetActiveSpecMask(), true);
                player->learnSpell(14983); player->addTalent(14983, player->GetActiveSpecMask(), true);
                player->learnSpell(13792); player->addTalent(13792, player->GetActiveSpecMask(), true);
                player->learnSpell(58425); player->addTalent(58425, player->GetActiveSpecMask(), true);
                player->learnSpell(13971); player->addTalent(13971, player->GetActiveSpecMask(), true);
                player->learnSpell(14072); player->addTalent(14072, player->GetActiveSpecMask(), true);
                player->learnSpell(14094); player->addTalent(14094, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(14066); player->addTalent(14066, player->GetActiveSpecMask(), true);
                player->learnSpell(14173); player->addTalent(14173, player->GetActiveSpecMask(), true);
                player->learnSpell(13980); player->addTalent(13980, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(31230); player->addTalent(31230, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(58415); player->addTalent(58415, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 10:
                ...
                player->learnSpell(19552); player->addTalent(19552, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(19624); player->addTalent(19624, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(34954); player->addTalent(34954, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 11:
                ...
                player->learnSpell(19417); player->addTalent(19417, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(19509); player->addTalent(19509, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(52788); player->addTalent(52788, player->GetActiveSpecMask(), true);
                player->learnSpell(19500); player->addTalent(19500, player->GetActiveSpecMask(), true);
                player->learnSpell(24283); player->addTalent(24283, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 13:
                ...
                player->learnSpell(33172); player->addTalent(33172, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(57470); player->addTalent(57470, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(47509); player->addTalent(47509, player->GetActiveSpecMask(), true);
                player->learnSpell(33206); player->addTalent(33206, player->GetActiveSpecMask(), true);
                player->learnSpell(47517); player->addTalent(47517, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 14:
                ...
                // Talent
                player->learnSpell(14791); player->addTalent(14791, player->GetActiveSpecMask(), true);
                player->learnSpell(14784); player->addTalent(14784, player->GetActiveSpecMask(), true);
                player->learnSpell(14771); player->addTalent(14771, player->GetActiveSpecMask(), true);
                player->learnSpell(14777); player->addTalent(14777, player->GetActiveSpecMask(), true);
                player->learnSpell(14751); player->addTalent(14751, player->GetActiveSpecMask(), true);
                player->learnSpell(15012); player->addTalent(15012, player->GetActiveSpecMask(), true);
                player->learnSpell(17191); player->addTalent(17191, player->GetActiveSpecMask(), true);
                player->learnSpell(15010); player->addTalent(15010, player->GetActiveSpecMask(), true);
                player->learnSpell(18535); player->addTalent(18535, player->GetActiveSpecMask(), true);
                player->learnSpell(19236); player->addTalent(19236, player->GetActiveSpecMask(), true);
                player->learnSpell(15363); player->addTalent(15363, player->GetActiveSpecMask(), true);
                player->learnSpell(15017); player->addTalent(15017, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(15354); player->addTalent(15354, player->GetActiveSpecMask(), true);
                player->learnSpell(34860); player->addTalent(34860, player->GetActiveSpecMask(), true);
                player->learnSpell(724); player->addTalent(724, player->GetActiveSpecMask(), true);
                player->learnSpell(33146); player->addTalent(33146, player->GetActiveSpecMask(), true);
                player->learnSpell(64129); player->addTalent(64129, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(47566); player->addTalent(47566, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 15:
                ...
                player->learnSpell(14751); player->addTalent(14751, player->GetActiveSpecMask(), true);
                player->learnSpell(14781); player->addTalent(14781, player->GetActiveSpecMask(), true);
                player->learnSpell(15310); player->addTalent(15310, player->GetActiveSpecMask(), true);
                player->learnSpell(15320); player->addTalent(15320, player->GetActiveSpecMask(), true);
                player->learnSpell(15317); player->addTalent(15317, player->GetActiveSpecMask(), true);
                player->learnSpell(15328); player->addTalent(15328, player->GetActiveSpecMask(), true);
                player->learnSpell(15448); player->addTalent(15448, player->GetActiveSpecMask(), true);
                player->learnSpell(15314); player->addTalent(15314, player->GetActiveSpecMask(), true);
                player->learnSpell(15407); player->addTalent(15407, player->GetActiveSpecMask(), true);
                player->learnSpell(15311); player->addTalent(15311, player->GetActiveSpecMask(), true);
                player->learnSpell(17323); player->addTalent(17323, player->GetActiveSpecMask(), true);
                player->learnSpell(15332); player->addTalent(15332, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(47582); player->addTalent(47582, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 16:
                ...
                // Talent
                player->learnSpell(49500); player->addTalent(49500, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(49509); player->addTalent(49509, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(49543); player->addTalent(49543, player->GetActiveSpecMask(), true);
                player->learnSpell(49016); player->addTalent(49016, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(50031); player->addTalent(50031, player->GetActiveSpecMask(), true);
                player->learnSpell(50147); player->addTalent(50147, player->GetActiveSpecMask(), true);
                player->learnSpell(49789); player->addTalent(49789, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 17:
                ...
                player->learnSpell(49491); player->addTalent(49491, player->GetActiveSpecMask(), true);
                player->learnSpell(49508); player->addTalent(49508, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(50887); player->addTalent(50887, player->GetActiveSpecMask(), true);
                player->learnSpell(49039); player->addTalent(49039, player->GetActiveSpecMask(), true);
                player->learnSpell(51473); player->addTalent(51473, player->GetActiveSpecMask(), true);
                player->learnSpell(51129); player->addTalent(51129, player->GetActiveSpecMask(), true);
                player->learnSpell(50115); player->addTalent(50115, player->GetActiveSpecMask(), true);
                player->learnSpell(49657); player->addTalent(49657, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(55610); player->addTalent(55610, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(51271); player->addTalent(51271, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 19:
                ...
                player->learnSpell(16116); player->addTalent(16116, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(16303); player->addTalent(16303, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 20:
                ...
                // Talent
                player->learnSpell(16108); player->addTalent(16108, player->GetActiveSpecMask(), true);
                player->learnSpell(28997); player->addTalent(28997, player->GetActiveSpecMask(), true);
                player->learnSpell(29180); player->addTalent(29180, player->GetActiveSpecMask(), true);
                player->learnSpell(16115); player->addTalent(16115, player->GetActiveSpecMask(), true);
                player->learnSpell(16164); player->addTalent(16164, player->GetActiveSpecMask(), true);
                player->learnSpell(16130); player->addTalent(16130, player->GetActiveSpecMask(), true);
                player->learnSpell(17487); player->addTalent(17487, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(51527); player->addTalent(51527, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 21:
                ...
                player->learnSpell(30885); player->addTalent(30885, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 22:
                ...
                player->learnSpell(12605); player->addTalent(12605, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(55339); player->addTalent(55339, player->GetActiveSpecMask(), true);
                player->learnSpell(31570); player->addTalent(31570, player->GetActiveSpecMask(), true);
                player->learnSpell(12043); player->addTalent(12043, player->GetActiveSpecMask(), true);
                player->learnSpell(12501); player->addTalent(12501, player->GetActiveSpecMask(), true);
                player->learnSpell(54354); player->addTalent(54354, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(44396); player->addTalent(44396, player->GetActiveSpecMask(), true);
                player->learnSpell(44379); player->addTalent(44379, player->GetActiveSpecMask(), true);
                player->learnSpell(31585); player->addTalent(31585, player->GetActiveSpecMask(), true);
                player->learnSpell(31589); player->addTalent(31589, player->GetActiveSpecMask(), true);
                player->learnSpell(54489); player->addTalent(54489, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 23:
                ...
                player->learnSpell(54749); player->addTalent(54749, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(11095); player->addTalent(11095, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(12400); player->addTalent(12400, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 24:
                ...
                player->learnSpell(12952); player->addTalent(12952, player->GetActiveSpecMask(), true);
                player->learnSpell(12472); player->addTalent(12472, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(44557); player->addTalent(44557, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 25:
                ...
                player->learnSpell(18182); player->addTalent(18182, player->GetActiveSpecMask(), true);
                player->learnSpell(17805); player->addTalent(17805, player->GetActiveSpecMask(), true);
                player->learnSpell(53754); player->addTalent(53754, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(32392); player->addTalent(32392, player->GetActiveSpecMask(), true);
                player->learnSpell(18275); player->addTalent(18275, player->GetActiveSpecMask(), true);
                player->learnSpell(47197); player->addTalent(47197, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 28:
                ...
                player->learnSpell(16846); player->addTalent(16846, player->GetActiveSpecMask(), true);
                player->learnSpell(35364); player->addTalent(35364, player->GetActiveSpecMask(), true);
                player->learnSpell(16822); player->addTalent(16822, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(57851); player->addTalent(57851, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(33607); player->addTalent(33607, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(17060); player->addTalent(17060, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 29:
                ...
                player->learnSpell(16860); player->addTalent(16860, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(37117); player->addTalent(37117, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(34300); player->addTalent(34300, player->GetActiveSpecMask(), true);
                player->learnSpell(33957); player->addTalent(33957, player->GetActiveSpecMask(), true);
                player->learnSpell(33859); player->addTalent(33859, player->GetActiveSpecMask(), true);
                ...
                player->learnSpell(17073); player->addTalent(17073, player->GetActiveSpecMask(), true);
            ...
            case GOSSIP_ACTION_INFO_DEF + 30:
                ...
                player->learnSpell(48496); player->addTalent(48496, player->GetActiveSpecMask(), true);
                player->learnSpell(48545); player->addTalent(48545, player->GetActiveSpecMask(), true);
                player->learnSpell(65139); player->addTalent(65139, player->GetActiveSpecMask(), true);
                player->learnSpell(48537); player->addTalent(48537, player->GetActiveSpecMask(), true);
                player->learnSpell(63411); player->addTalent(63411, player->GetActiveSpecMask(), true);
                player->learnSpell(51183); player->addTalent(51183, player->GetActiveSpecMask(), true);
                player->learnSpell(48438); player->addTalent(48438, player->GetActiveSpecMask(), true);
